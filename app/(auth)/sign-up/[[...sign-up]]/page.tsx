...
const features = [
  "5 fontes gratuitas para começar",
  "10 buscas com IA por dia",
  "Histórico e favoritos inclusos",
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "100vh", width: "100%" }}>
      ...
      <div style={{ background: "linear-gradient(155deg,#0b1a3e 0%,#0d2260 45%,#1a3a7a 100%)", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "48px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <h2 style={{ fontSize: "26px", fontWeight: 700, color: "#fff", lineHeight: 1.3, marginBottom: "12px" }}>Comece grátis hoje</h2>
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, marginBottom: "20px" }}>Crie sua conta e comece a buscar imóveis em dezenas de imobiliárias ao mesmo tempo.</p>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 24px", background: "#f8fafc" }}>
        <div style={{ width: "100%", maxWidth: "400px" }}>
          <h1 style={{ fontSize: "22px", fontWeight: 700, color: "#0f172a", marginBottom: "6px" }}>Criar conta grátis</h1>
          <p style={{ fontSize: "13.5px", color: "#64748b", marginBottom: "28px" }}>
            Já tem conta?{" "}
            <Link href="/sign-in" style={{ color: "#2563eb", textDecoration: "none" }}>Entrar</Link>
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "16px" }}>
            <button
              ...
              style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", width: "100%", padding: "10px", background: "#fff", border: "1.5px solid #e2e8f0", borderRadius: "9px", fontSize: "13.5px", fontWeight: 600, color: "#374151", cursor: "pointer", fontFamily: "inherit" }}
            >
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: "14px" }}>
              <label style={{ display: "block", fontSize: "12.5px", fontWeight: 600, color: "#374151", marginBottom: "6px" }}>Nome</label>
              <input
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              <input
                type="email" placeholder="seunome@email.com" value={form.email}
                onChange={(e) => setForm({ ...form, email: e.target.value })} required
                style={{ width: "100%", boxSizing: "border-box", padding: "10px 12px", border: "1.5px solid #e2e8f0", borderRadius: "9px", fontSize: "14px", fontFamily: "inherit", color: "#0f172a", background: "#fff", outline: "none" }}
              />
            </div>
            <div style={{ marginBottom: "20px" }}>
              <label style={{ display: "block", fontSize: "12.5px", fontWeight: 600, color: "#374151", marginBottom: "6px" }}>Senha</label>
              <input
            ...
            <p style={{ fontSize: "12px", color: "#94a3b8", textAlign: "center", marginTop: "16px" }}>
              ...
              <a href="#" style={{ color: "#2563eb", textDecoration: "none" }}>Termos de Uso</a>
            </p>
          </form>
        </div>
      </div>
